          ...
          <div class="panel-heading">Add new collection</div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('genus') ? ' has-error' : '' }}">
                <label for="genus" class="col-md-2 control-label">Genus:</label>
                    <div class="col-md-8">
              ...
              <div class="form-group{{ $errors->has('synonim') ? ' has-error' : '' }}">
                <label for="synonim" class="col-md-2 control-label">Synonim:</label>
                    <div class="col-md-8">
                      <i>
...
<div class="col-md-12">
          ...
          <div class="form-group{{ $errors->has('distribution') ? ' has-error' : '' }}">
            <label for="distribution" class="col-md-1 control-label">Distribution:</label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label for="ecology" class="col-md-1 control-label">Ecology:</label>
                  <div class="col-md-8">
            ...
            <div class="form-group">
                <label for="chemical_ctrl" class="col-md-1 control-label">Chemical Control:</label>
                  <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('manual_ctrl') ? ' has-error' : '' }}">
                <label for="manual_ctrl" class="col-md-1 control-label">Manual Control:</label>
                    <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('biological_ctrl') ? ' has-error' : '' }}">
                <label for="biological_ctrl" class="col-md-1 control-label">Biological Control :</label>
                    <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('prevention') ? ' has-error' : '' }}">
                <label for="preventioin" class="col-md-1 control-label">Prevention:</label>
                    <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('utilization') ? ' has-error' : '' }}">
                <label for="utilization" class="col-md-1 control-label">Uses:</label>
                      <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('risk_analisis') ? ' has-error' : '' }}">
                <label for="risk_analisis" class="col-md-1 control-label">Risk Analysis:</label>
                    <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                  <label for="contact" class="col-md-1 control-label">Contact Person:</label>
                      <div class="col-md-8">
            ...
            <div class="form-group{{ $errors->has('reference') ? ' has-error' : '' }}">
                <label for="reference" class="col-md-1 control-label">Reference :</label>
                    <div class="col-md-8">
              ...
              <div class="form-group{{ URL::to('upload') }}" method="post" enctype="multipart/form-data">
                  <label for="picture" class="col-md-1 control-label">Select image to upload :</label>
                    <!-- Pilih Gambar 1 -->
                    <div class="col-md-3">
                    <div class="col-md-8">
